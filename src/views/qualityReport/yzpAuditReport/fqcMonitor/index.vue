  ...
  <PageHeaderLayout >
          ...
          <div class="input-item">
            ...
            <!-- <el-select v-model="model" class="search-input" size="small" placeholder="请选择" filterable clearable>
              <el-option
                ...
                :key="item.id"
                :label="item.code.substring(0, item.code.length - 4)"
                :value="item.code"/>
            </el-select> -->
            <el-select v-model="model" class="search-input" size="small" placeholder="请选择" filterable clearable>
              <el-option
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column v-if="isActive !== 1" label="综合良率" align="center" prop="slice">
          <template slot-scope="scope">
            {{ scope.row.compreYield }}
          </template>
        </el-table-column>
        <el-table-column label="VF" align="center" prop="vf"/>
        ...
        <el-table-column label="WLP" align="center" prop="wlp"/>
      </el-table>
      <el-pagination
