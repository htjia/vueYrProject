...
import { selectAll } from '@/api/baobiao/fqcMonitor'
export default {
  ...
  methods: {
    ...
    importExcel() {
      ...
      window.open(process.env.BASE_API + '/xpFQCDataMonitoring/export?startTime=' + this.formatDate(this.beginDate) + '&endTime=' + this.formatDate(this.endDate) + '&productCode=' + cos + '&size=' + ((this.sizeType === '' || this.sizeType === null) ? '' : this.sizeType.substring(0, 1)) + '&sliceType=' + this.isActive, '_blank')
    },
    // 每页数量改变
    sizeChange(pageSize) {
