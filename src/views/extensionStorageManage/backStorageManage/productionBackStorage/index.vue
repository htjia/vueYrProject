  ...
  <PageHeaderLayout >
    <div class="header-search-add height-auto">
      <div style="height: auto;">
        <el-button
          ...
          type="primary"
          @click="viewBackInfo"
        ><svg-icon icon-class="shenheth"/> 生产退库记录</el-button>
        <div class="input-item">
          <span class="input-title" style="width: 35px;">单号 </span>
          <el-input :disabled="true" v-model="listNum" class="search-input search-input-short" style="width: 120px" size="small" maxlength="20" clearable/>
        </div>
        <div class="input-item">
          <span class="input-title" style="width: 50px;">制单人 </span>
          <el-input :disabled="true" v-model="creater" class="search-input search-input-short" style="width: 100px" size="small" maxlength="20" clearable/>
        </div>
        <div class="input-item">
          <span class="input-title">退库类型 </span>
          <el-select v-model="backType" class="search-input search-input-short" style="width: 100px" size="small" placeholder="请选择" filterable clearable>
            <el-option
    ...
    <div class="app-container">
      <div class="input-item" style="margin-top: 0;margin-bottom: 10px">
        <el-select v-model="selectType" class="search-input" style="width: 100px;" size="small" placeholder="请选择" filterable clearable>
          <el-option
        ...
        <el-input v-model="inputValue" class="search-input search-input-short" size="small" maxlength="20" clearable style="width: 220px;"/>
        <el-button
          class="margin-left"
          size="small"
          type="primary"
      ...
      <el-table
        ...
        <el-table-column align="center" label="WaferID" prop="waferId" width="120" show-overflow-tooltip fixed/>
        ...
        <el-table-column align="center" label="WLD1" prop="wld1" width="120" show-overflow-tooltip/>
    ...
    <el-dialog
      ...
      <div class="search-box" style="padding: 8px 0;overflow: hidden">
        <div class="input-item">
      ...
      >
        ...
        <el-table-column label="退库类型" align="center" prop="backTypeName" show-overflow-tooltip/>
