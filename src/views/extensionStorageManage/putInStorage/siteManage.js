    ...
    getGroup(arr) {
      ...
      if (Array.isArray(arr)) {
        for (var i = 0; i < arr.length; ++i) {
          var wyBoxNo = arr[i].wyBoxNo
          if (wyBoxNo in obj) obj[wyBoxNo]++
          else { obj[wyBoxNo] = 1 }
        }
      }
      return obj
    ...
    handleSearch() {
      ...
      findWyWareHousList(params).then(res => {
        ...
        if (hasWafer.length === 0) {
          this.group = this.getGroup(res.data)
          // const arr = []
          // res.data.map(item => {
          //
          // })
          ...
          this.sliceTotalNum = res.data.length
      ...
      if (res.code !== 0) {
        ...
        if (hasWafer.length === 0) {
          ...
          res.data.waferList.map(item => {
            item.esd200v = item.esd200v === '' ? '' : parseFloat(item.esd200v * 100).toFixed(2) + '%'
            item.esd50v = item.esd50v === '' ? '' : parseFloat(item.esd50v * 100).toFixed(2) + '%'
            item.esd500 = item.esd500 === '' ? '' : parseFloat(item.esd500 * 100).toFixed(2) + '%'
            item.esd300 = item.esd300 === '' ? '' : parseFloat(item.esd300 * 100).toFixed(2) + '%'
            item.plWd = item.plWd === '' ? '' : parseFloat(item.plWd).toFixed(2)
            item.plWtd = item.plWtd === '' ? '' : parseFloat(item.plWtd).toFixed(2)
            item.plIi = item.plIi === '' ? '' : parseFloat(item.plIi).toFixed(2)
            item.plIiStd = item.plIiStd === '' ? '' : parseFloat(item.plIiStd).toFixed(2)
            ...
            item.plintStd = item.plintStd === '' ? '' : parseFloat(item.plintStd).toFixed(2)
            item.avgVf4 = item.avgVf4 === '' ? '' : parseFloat(item.avgVf4).toFixed(3)
            item.yield = item.yield === '' ? '' : parseFloat(item.yield * 100).toFixed(2) + '%'
            item.vf1Yield = item.vf1Yield === '' ? '' : parseFloat(item.vf1Yield * 100).toFixed(2) + '%'
            item.lrYield = item.lrYield === '' ? '' : parseFloat(item.lrYield * 100).toFixed(2) + '%'
            item.vzYield = item.vzYield === '' ? '' : parseFloat(item.vzYield * 100).toFixed(2) + '%'
            item.esd400 = item.esd400 === '' ? '' : parseFloat(item.esd400 * 100).toFixed(2) + '%'
            item.yieldIr02 = item.yieldIr02 === '' ? '' : parseFloat(item.yieldIr02 * 100).toFixed(2) + '%'
            item.thyristor = item.thyristor === '' ? '' : parseFloat(item.thyristor * 100).toFixed(2) + '%'
          })
