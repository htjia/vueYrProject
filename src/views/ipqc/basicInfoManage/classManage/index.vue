  ...
  <PageHeaderLayout >
    ...
    <div class="app-container left">
      <el-table
        ...
        <el-table-column label="班别" align="center" prop="name"/>
        <el-table-column label="时间范围" align="center" prop="status">
          <template slot-scope="scope">
    ...
    <el-dialog
      ...
      <el-form ref="programForm" :model="programForm" :rules="rules" status-icon label-width="80px" label-position="right">
        <el-form-item label="班别" prop="name">
          <el-input v-model="programForm.name" placeholder="请输入班别" type="text" maxlength="5"/>
        </el-form-item>
        <el-form-item label="时间范围" required>
          <el-row>
            <el-col :span="11">
              <el-row>
                <el-col :span="11">
                  <el-form-item prop="sthours">
                    <el-select
                      v-model="programForm.sthours"
                      size="small"
                      filterable
                      style="width:91px"
                      placeholder="请选择"
                ...
                <el-col :span="11">
                  <el-form-item prop="stminutes">
                    <el-select
                      v-model="programForm.stminutes"
                      size="small"
                      filterable
                      class="tip-out-input"
                      style="width:91px"
              ...
              <el-row>
                ...
                <el-col :span="11">
                  <el-form-item prop="endminutes">
                    <el-select
                      v-model="programForm.endminutes"
                      size="small"
                      filterable
                      class="tip-out-input"
                      style="width:91px"
        ...
        <el-form-item label="班别时长" prop="duration">
          <el-input v-model="programForm.duration" :disabled="true" placeholder="" type="text" maxlength="5"/>
        </el-form-item>
    ...
    <el-dialog
      ...
      <el-form ref="programForm" :model="programForm" :rules="rules" status-icon label-width="80px" label-position="right">
        <el-form-item label="班别" prop="name">
          <el-input v-model="programForm.name" :disabled="true" placeholder="请输入班别" type="text" maxlength="5"/>
        </el-form-item>
        <el-form-item label="时间范围" required>
          <el-row>
            <el-col :span="11">
