<template>
  <PageHeaderLayout >
    ...
    <el-row v-show="isActive === 0">
      <el-col :span="24" style="background-color: #fff;padding: 0 15px; 15px; 15px;">
        <div class="input-item">
          ...
          <el-input v-model="bitchNo" class="search-input" style="width:200px" placeholder="请输入批号" size="small" maxlength="20" clearable/>
        </div>
        <div class="input-item">
          <span class="input-title">WaferID</span>
          <el-input v-model="waferId" class="search-input" style="width:260px" placeholder="请输入WaferID" size="small" maxlength="100" clearable/>
        </div>
        <div class="input-item">
        ...
        <div class="input-item">
          ...
          <el-select v-model="tpType" class="search-input" size="small" placeholder="请选择" filterable clearable>
            <el-option
        ...
        <div style="margin-right: 0px;float: right;margin-top: 15px;">
          <el-button
            size="small"
            type="primary"
            @click="addBaoFei" ><svg-icon icon-class="xuanzexx"/> 提交报废</el-button>
          <el-button
            size="small "
            type="primary"
            @click="importDBF"
    ...
    <el-row v-show="isActive === 1">
      <el-col :span="24" style="background-color: #fff;padding: 0 15px; 15px; 15px;">
        ...
        <div class="input-item">
          ...
          <a v-if="!isSpan" class="info" @click="setSpan"><i class="el-icon-arrow-down"/> 展开</a>
          <a v-if="isSpan" class="info" @click="setSpan"><i class="el-icon-arrow-up"/> 收起</a>
    ...
    <div class="app-container" style="box-shadow: none;">
      <el-table
        v-loading="listLoading"
        v-show="isActive === 0"
        :data="list"
        class="broad-scrollbar-table setss"
        ...
        <el-table-column label="检出工序" align="center" width="150px" prop="checkOutProcess"/>
        ...
        <el-table-column label="责任部门" align="center" prop="responsibleDept" width="150px" show-overflow-tooltip/>
        ...
        <el-table-column label="操作" align="center" prop="status" fixed="right">
          <template slot-scope="scope">
            <el-button
              ...
              size="mini"
              type="danger"
              @click="cancelPendingData(scope.row)"
            ><svg-icon icon-class="return"/> 撤销</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-table
        ...
        <el-table-column label="操作" align="center" prop="status" width="270px">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="primary"
            ...
            <el-button
              ...
              v-show="isShowMenu['scrapAudit-auditor']"
              size="mini"
              type="danger"
...
<style scoped>
  ...
  .setss >>>.el-table__fixed-right {
    height: calc(100vh - 370px) !important;
  }
  .setss >>>.el-table__fixed {
    height: calc(100vh - 314px) !important;
  }
  .setss>>>.el-table__fixed-body-wrapper {
    height: calc(100vh - 353px) !important;
  }
  .sess>>>.el-table__fixed-body-wrapper {
