  ...
  <PageHeaderLayout >
    ...
    <div class="app-container">
      ...
      <el-table
        ...
        fit
      >
        <el-table-column :label="processName+'-电极厚度测试SPC管理图'" align="center">
          <el-table-column label="制程名称" align="center" prop="code">
            <template slot-scope="scope">
              <span v-if="scope.row.sign === 0">电极蒸镀</span>
            </template>
          </el-table-column>
          <el-table-column label="控制项目" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.sign === 0">电极厚度</span>
            </template>
          </el-table-column>
    ...
    <div class="module-container" style="margin-top: 10px;">
      <div class="module-title">
        <div class="module-title-text">电极厚度 埃（Å）</div>
      </div>
    ...
    <div class="module-container" style="margin-top: 10px;">
      <div class="module-title">
        <div class="module-title-text">电极厚度-MR</div>
      </div>
      <div class="module-content" style="height: 300px;">
        <div v-if="anotherLists.length === 0" class="no-data">
          <svg-icon class="no-data-icon" icon-class="noData"/>
    ...
    <el-dialog
      ...
      <el-table
        ...
        <el-table-column label="电极厚度" align="center" prop="djhd"/>
        <el-table-column label="电极厚度-MR" align="center" prop="djhdmr"/>
      </el-table>
