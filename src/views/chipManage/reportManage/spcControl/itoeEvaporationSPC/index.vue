  ...
  <PageHeaderLayout >
    ...
    <div class="app-container">
      ...
      <el-table
        ...
        fit
      >
        <el-table-column :label="processName+'-ITO膜透明度及片电阻测试SPC管理图'" align="center">
          <el-table-column label="制程名称" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.sign !== -1">ITO膜蒸镀</span>
            </template>
          </el-table-column>
          <el-table-column label="控制项目" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.sign === 0">片电阻</span>
              <span v-if="scope.row.sign === 1">透光度</span>
            </template>
          </el-table-column>
          <el-table-column label="测量单位" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.sign === 0">Ω/cm2</span>
              <span v-if="scope.row.sign === 1">%(460nm)</span>
            </template>
          </el-table-column>
    ...
    <div class="module-container" style="margin-top: 10px;">
      <div class="module-title">
        <div class="module-title-text">片电阻Ω/cm2</div>
      </div>
    ...
    <div class="module-container" style="margin-top: 10px;">
      <div class="module-title">
        <div class="module-title-text">片电阻-MR</div>
      </div>
      <div class="module-content" style="height: 300px;">
        <div v-if="anotherLists.length === 0" class="no-data">
          <svg-icon class="no-data-icon" icon-class="noData"/>
    ...
    <div class="module-container" style="margin-top: 10px;">
      <div class="module-title">
        <div class="module-title-text">透光度（%）</div>
      </div>
      <div class="module-content" style="height: 300px;">
        <div v-if="anotherLists.length === 0" class="no-data">
          <svg-icon class="no-data-icon3" icon-class="noData"/>
          <div>暂无数据</div>
        </div>
        <chart v-if="anotherLists.length !== 0" id="tgdds" :options="option3" height="300px" width="100%"/>
      </div>
    </div>
    <div class="module-container" style="margin-top: 10px;">
      <div class="module-title">
        <div class="module-title-text">透光度-MR</div>
      </div>
      <div class="module-content" style="height: 300px;">
        <div v-if="anotherLists.length === 0" class="no-data">
          <svg-icon class="no-data-icon" icon-class="noData"/>
        ...
        <chart v-if="anotherLists.length !== 0" id="tgdmr" :options="option4" height="300px" width="100%"/>
      </div>
    </div>
    <el-dialog
      v-drag
      ...
      <el-table
        ...
        fit
        stripe>
        <el-table-column label="Run编号" align="center" prop="run"/>
        <el-table-column label="片电阻" align="center" prop="pdz"/>
        <el-table-column label="片电阻-MR" align="center" prop="pdzmr"/>
        <el-table-column label="透光度" align="center" prop="tgd"/>
        <el-table-column label="透光度-MR" align="center" prop="tgdmr"/>
      </el-table>
