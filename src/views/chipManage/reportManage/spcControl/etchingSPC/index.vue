  ...
  <PageHeaderLayout >
    ...
    <div class="app-container">
      ...
      <el-table
        ...
        fit
      >
        <el-table-column :label="processName+'深度测量SPC管理图'" align="center">
          <el-table-column label="制程名称" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.sign === 0">ICP蚀刻</span>
            </template>
          </el-table-column>
          <el-table-column label="控制项目" align="center" width="150px">
            <template slot-scope="scope">
              <span v-if="scope.row.sign === 0">刻蚀深度(13#/20#)</span>
            </template>
          </el-table-column>
    ...
    <div class="module-container" style="margin-top: 10px;">
      <div class="module-title">
        <div class="module-title-text">蚀刻深度 埃（Å）</div>
      </div>
    ...
    <div class="module-container" style="margin-top: 10px;">
      <div class="module-title">
        <div class="module-title-text">蚀刻深度-MR</div>
      </div>
      <div class="module-content" style="height: 300px;">
        <div v-if="anotherLists.length === 0" class="no-data">
          <svg-icon class="no-data-icon" icon-class="noData"/>
    ...
    <el-dialog
      ...
      <el-table
        ...
        <el-table-column label="蚀刻深度" align="center" prop="skAvg"/>
        <el-table-column label="蚀刻深度-MR" align="center" prop="skmr"/>
      </el-table>
