  ...
  <PageHeaderLayout >
      ...
      <div class="search-box">
        <div class="left-search-box" style="margin-left: -20px;">
          <div class="input-item">
            <span class="input-title" style="width: 80px;">ChipNo </span>
            <el-input v-model="chipNo" class="search-input" style="width: 190px" placeholder="请输入ChipNo" size="small" maxlength="20" clearable/>
          </div>
          <div class="input-item">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="ChipNo" align="center" prop="binNo" width="200px" fixed/>
        <el-table-column label="TapeNo" align="center" prop="tapeNo" width="200px" fixed/>
        <el-table-column v-for="item in formThead" v-if="item.thName !== '序号'&&item.thName !== 'ChipNo'&&item.thName !== 'TapeNo'" :key="item.thName" :label="item.thName" :width="item.width" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
    ...
    <el-dialog
      ...
      <el-form ref="dialogForm" :model="dialogForm" :rules="rules" size="small" status-icon label-width="115px" label-position="right">
        <div class="tits" style="margin-top: -15px;">
          <div class="bords">基本参数</div>
        </div>
        <el-row>
          <el-col :span="6">
            <el-form-item label="ChipNo " prop="binNo">
              <el-input v-model="dialogForm.binNo" size="small" placeholder="请输入" maxlength="50"/>
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="电极代码 " prop="electrode">
              <el-input v-model="dialogForm.electrode" size="small" placeholder="请输入" maxlength="3"/>
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="下bin时间 " prop="binTime" style="margin-bottom: 0px;">
              <el-date-picker
                v-model="dialogForm.binTime"
                :editable="false"
                size="small"
                type="datetime"
                style="width: 100%;"
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="Bin类型 " prop="binType">
              <el-select v-model="dialogForm.binType" size="small" placeholder="请选择" filterable clearable>
                <el-option
                  v-for="item in binLists"
                  :key="item.name"
                  :label="item.name"
                  :value="item.name"/>
              </el-select>
    ...
    <el-dialog
      ...
      <el-form ref="dialogForm" :model="dialogForm" :rules="rules" size="small" status-icon label-width="115px" label-position="right">
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="电极代码 " prop="electrode">
              <el-input v-model="dialogForm.electrode" size="small" placeholder="请输入" maxlength="5"/>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="颗粒数 " prop="sliceCount">
