  ...
  <PageHeaderLayout >
    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;">
          ...
          <el-input :disabled="true" value="光刻胶涂布" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
      ...
      <el-row :gutter="15">
        <el-col :span="8">
          ...
          <div class="left-content" style="height: auto">
            ...
            <el-select :disabled="jProcess === ''" v-model="machineNum" class="dialog-input-short" size="small" placeholder="请选择" filterable @change="machineChange">
              <el-option
            ...
            <el-select v-if="machineType === 0" :disabled="machineNum === ''" v-model="rubberNum" class="dialog-input-short" size="small" placeholder="请选择" filterable clearable @change="findGrandTotalFun">
              <el-option
            ...
            <el-select v-if="machineType === 1" :disabled="machineNum === ''" v-model="rubberNum" class="dialog-input-short" size="small" placeholder="请选择" filterable clearable @change="findGrandTotalFun">
              <el-option
            ...
            <div class="left-content" style="height: auto">
              <div v-for="item in handParams" :key="item.paramsName">
                <span class="input-title" style="margin-top: 15px; width: 160px">{{ item.paramsName }}</span>
                <el-input v-model="item.val" :disabled="motionRadio === 1" type="number" class="dialog-input-short" style="margin-top: 10px;width: 130px" size="small" onkeyup="if(this.value.length > 10){this.value = this.value.slice(0, 10)}" @input="inputChange(item)"/>
              </div>
            </div>
          </div>
        </el-col>
    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;margin-right: 0">
          <span class="input-title-short"><svg-icon icon-class="jianyansz" style="font-size: 20px;color:#009494"/> 工序</span>
          <el-select v-model="jProcess" class="search-input-scan-input" size="small" placeholder="请选择" filterable @change="processCChange">
            <el-option
              v-for="item in proceOptions"
              :key="item.id"
              :label="item.name"
