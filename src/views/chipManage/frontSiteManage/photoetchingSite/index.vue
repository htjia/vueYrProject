    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;">
          ...
          <el-input :disabled="true" value="光刻" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
    ...
    <el-dialog
      ...
      <el-row :gutter="15">
        <el-col :span="8">
          ...
          <div class="left-content" style="height: 422px">
            ...
            <!--<span class="input-title" style="margin-top: 15px; width: 100px">原材料 </span>
            <el-input v-model="material" class="dialog-input-short" style="margin-top: 10px" size="small" placeholder="请输入原材料" maxlength="20" clearable/>
            <span class="input-title" style=" width: 100px;">累计片数 </span>
            <el-input v-model="grandTotal" :disabled="true" class="dialog-input-short" style="margin-top: 10px" size="small" placeholder="请输入累计片数" maxlength="20" clearable/>
            <span class="input-title" style=" width: 100px;">阈值 </span>
            <el-input v-model="threshold" :disabled="true" class="dialog-input-short" style="margin-top: 10px" size="small" placeholder="请输入阈值" maxlength="20" clearable/>-->
