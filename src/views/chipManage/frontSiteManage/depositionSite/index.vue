    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;">
          ...
          <el-input :disabled="true" value="沉积" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
        ...
        <el-col :span="8">
          ...
          <div class="left-content" style="height: auto">
            <div v-for="item in handParams" :key="item.paramsName">
              <span class="input-title" style="margin-top: 15px; width: 95px">{{ item.paramsName }}</span>
              <el-input v-model="item.val" :disabled="motionRadio === 1" class="dialog-input-short" style="margin-top: 10px;width: 220px" size="small" maxlength="20" clearable/>
            </div>
          </div>
        </el-col>
        <el-col :span="16">
        ...
        <el-col :span="8">
          ...
          <div class="left-content" style="height: auto">
            <div v-for="item in handTestParams" :key="item.paramsName">
              ...
              <el-input
                v-if="item.paramsCode !== 'machineCode'"
                v-model="item.val"
                :disabled="motionRadio === 1"
                class="dialog-input"
                style="margin-top: 10px;width:248px"
                size="small"
                type="number"
                onkeyup="if(this.value.length > 10){this.value = this.value.slice(0, 10)}"
                maxlength="20"
                clearable/>
              <el-select v-if="item.paramsCode === 'machineCode'" v-model="item.val" :disabled="jProcess === ''" class="dialog-input" style="margin-top: 10px;width:248px" size="small" placeholder="请选择" filterable clearable>
                <el-option
                  v-for="item in machinList"
                  :key="item.id"
                  :label="item.code"
