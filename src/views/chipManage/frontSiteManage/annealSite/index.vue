    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;">
          ...
          <el-input :disabled="true" value="退火" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
    ...
    <el-dialog
      ...
      <el-row :gutter="15">
        <el-col :span="8">
          ...
          <div v-if="motionRadio === 0" class="left-content" style="height: auto">
            <div v-for="item in handParams" :key="item.paramsName">
              ...
              <el-input v-model="item.val" class="dialog-input-short" type="number" style="margin-top: 10px;width: 170px" size="small" maxlength="20" @input="inputChange(item)"/>
            </div>
          </div>
          <div v-if="motionRadio === 1" class="left-content" style="height: auto">
            <div v-for="item in autoParams" :key="item.paramsName">
              <span class="input-title" style="margin-top: 15px; width: 100px">{{ item.paramsName }}</span>
              <el-input v-model="item.val" class="dialog-input-short" style="margin-top: 10px;width: 215px" size="small" maxlength="20" clearable/>
            </div>
          </div>
        </el-col>
        <el-col :span="16">
