    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;">
          ...
          <el-input :disabled="true" value="打胶站点" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
        ...
        <el-col :span="8">
          ...
          <div class="left-content" style="height: auto">
            <div v-for="item in handParams" :key="item.paramsName">
              ...
              <el-input v-model="item.val" :disabled="motionRadio === 1" class="dialog-input-short" style="margin-top: 10px;width: 215px" size="small" maxlength="20"/>
            </div>
          </div>
        </el-col>
        <el-col :span="16">
