    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;">
          ...
          <el-input :disabled="true" value="蚀刻" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
      ...
      <el-row :gutter="15">
        <el-col :span="8">
          ...
          <div class="left-content" style="height: auto">
            ...
            <el-select v-if="machineType === 0" :disabled="machineNum === ''" v-model="trench" class="dialog-input-short" size="small" placeholder="请选择" filterable clearable>
              <el-option
            ...
            <el-select v-if="machineType === 1" :disabled="machineNum === ''" v-model="trench" class="dialog-input-short" size="small" placeholder="请选择" filterable clearable>
              <el-option
          ...
          <div class="left-content" style="height: auto">
            <div v-for="item in handParams" :key="item.paramsName">
              <span class="input-title" style="margin-top: 15px; width: 70px">{{ item.paramsName }}</span>
              <el-input v-model="item.val" :disabled="motionRadio === 1" class="dialog-input-short" style="margin-top: 10px;width: 245px" size="small" maxlength="20" clearable/>
            </div>
          </div>
        </el-col>
        <el-col :span="16">
    ...
    <el-dialog
      ...
      <el-row :gutter="15">
        <el-col :span="8">
          ...
          <el-radio-group v-model="motionRadio" class="float-right" style="margin-top: 15px"><el-radio :label="1">自动</el-radio><el-radio :label="0">手动</el-radio></el-radio-group>
          <div class="left-content" style="height: auto">
            <div v-for="item in handTestParams" :key="item.paramsName">
              <span class="input-title" style="margin-top: 15px; width: 120px">{{ item.paramsName }}</span>
              <el-input v-if="item.paramsCode !== 'runbianhao'" v-model="item.val" class="dialog-input-short" style="margin-top: 10px;width: 195px" type="number" onkeyup="if(this.value.length > 10){this.value = this.value.slice(0, 10)}" size="small" maxlength="20" clearable/>
              <el-select v-if="item.paramsCode === 'runbianhao'" :disabled="motionRadio === 1" v-model="item.val" class="dialog-input-short" style="margin-top: 10px;width: 195px" size="small" placeholder="请选择" filterable >
                <el-option
