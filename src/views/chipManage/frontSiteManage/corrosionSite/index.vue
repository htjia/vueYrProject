    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;">
          ...
          <el-input :disabled="true" value="腐蚀站点" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
        ...
        <el-col :span="8">
          ...
          <div class="left-content" style="height: auto">
            <div v-for="item in handParams" :key="item.paramsName">
              ...
              <el-input v-model="item.val" :disabled="motionRadio === 1" type="number" class="dialog-input-short" style="margin-top: 10px;width: 170px" size="small" maxlength="20" onkeyup="if(this.value.length > 10){this.value = this.value.slice(0, 10)}" @input="inputChange(item)"/>
            </div>
          </div>
        </el-col>
        <el-col :span="16">
