  ...
  <PageHeaderLayout >
    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;">
          ...
          <el-input :disabled="true" value="腐蚀镜检" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;margin-right: 0">
          <span class="input-title-short"><svg-icon icon-class="jianyansz" style="font-size: 20px;color:#009494"/> 工序</span>
          <el-select v-model="jProcess" class="search-input-scan" size="small" placeholder="请选择" @change="processSChange">
            <el-option
              v-for="item in proceOptions"
              :key="item.id"
              :label="item.name"
