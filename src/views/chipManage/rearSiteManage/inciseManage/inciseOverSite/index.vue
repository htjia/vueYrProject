  ...
  <PageHeaderLayout >
    <div class="header-search-add height-auto">
      ...
      <div style="height: 45px;">
        <div class="input-item">
          ...
          <el-input v-model="batchNum" class="search-input" style="width: 400px;" placeholder="请输入批次号" size="small" maxlength="100" clearable/>
        </div>
        <div class="input-item">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column align="center" label="片数" prop="filmsNum" width="80" />
        <el-table-column align="center" label="片型" prop="patten" width="100" />
        <el-table-column align="center" label="尺寸" prop="size" width="80" />
        <el-table-column align="center" label="型号" prop="model" width="150" />
        ...
        <el-table-column align="center" label="备注" prop="receiveRemark" show-overflow-tooltip/>
        ...
        <el-table-column align="center" label="备注" prop="deliverRemark" show-overflow-tooltip/>
        <el-table-column align="center" label="原始文件" width="120" show-overflow-tooltip>
          <template slot-scope="scope">
            <div style="color: #009494;text-decoration: underline;cursor: pointer;" @click="downLoadFile(scope.row.batchNo)">点击下载</div>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        <div class="input-item" style="margin-top: 0">
          ...
          <el-input ref="importInputJp" :autofocus="true" v-model="jBatchNum" class="search-input-scan" placeholder="请输入批号" size="small" maxlength="100" clearable @keyup.enter.native="handleReceiveInput"/>
        </div>
        <div class="input-item" style="margin-top: 0;">
          <span class="input-title-short"><svg-icon icon-class="zhandiangl" style="font-size: 20px;color:#009494"/> 站点 </span>
          <el-input :disabled="true" value="切割过站" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
        <div class="input-item" style="margin-top: 0; margin-right: 0">
          ...
          <el-select v-model="jProcess" class="search-input-scan" size="small" placeholder="请选择" filterable>
            <el-option
    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        <div class="input-item" style="margin-top: 0">
          <span class="input-title"><svg-icon icon-class="tiaomasm" style="font-size: 20px;color:#009494"/> 批号扫描 </span>
          <el-input ref="importInputCp" :autofocus="true" v-model="cBatchNum" class="search-input-scan" placeholder="请输入批号" size="small" maxlength="100" clearable @keyup.enter.native="handleDeliverInput"/>
        </div>
        <div class="input-item" style="margin-top: 0;">
          <span class="input-title-short"><svg-icon icon-class="zhandiangl" style="font-size: 20px;color:#009494"/> 站点 </span>
          <el-input :disabled="true" value="切割过站" class="search-input-scan" size="small" maxlength="20" clearable/>
