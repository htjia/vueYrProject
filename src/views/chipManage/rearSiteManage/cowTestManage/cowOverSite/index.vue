  ...
  <PageHeaderLayout >
    <div class="header-search-add height-auto">
      ...
      <div style="height: auto;overflow: hidden">
        <div class="input-item">
          ...
          <el-input v-model="batchNum" class="search-input" style="width: 200px;" placeholder="请输入批次号" size="small" maxlength="50" clearable/>
        </div>
        <div class="input-item">
          <span class="input-title">投产类型 </span>
          <el-select v-model="chipType" class="search-input" size="small" placeholder="请选择" filterable clearable>
            <el-option
        ...
        <div class="input-item">
          <!--<el-radio-group v-model="timeRadio" class="margin-right"><el-radio :label="0">测试时间</el-radio><el-radio :label="1">过站时间</el-radio></el-radio-group>-->
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column align="center" label="投产类型" prop="produceName"/>
        <el-table-column align="center" label="判定结果" prop="decisionResults"/>
        ...
        <el-table-column align="center" label="接片人" prop="receiveName"/>
    ...
    <el-dialog
      ...
      <div class="overflow-hidden input-container">
        ...
        <div class="input-item" style="margin-top: 0;">
          ...
          <el-input :disabled="true" value="COW过站" class="search-input-scan" size="small" maxlength="20" clearable/>
        </div>
    ...
    <el-dialog
      ...
      width="800px"
    >
      <div>系统检测到以下wafer有多个 COW文件，请选择文件</div>
      <el-table
        v-loading="listLoading"
        :data="fileList"
        style="margin-top: 10px"
        ...
        <el-table-column align="center" label="生产类型" prop="productType" width="120"/>
        <el-table-column align="center" label="选择文件">
          <template slot-scope="scope">
            <el-radio v-for="file in scope.row.files" :key="file.id" :label="file.id" v-model="scope.row.selectedFile">{{ file.fileName }}</el-radio>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog
      v-drag
      :close-on-click-modal="false"
      :visible.sync="abnormalFeedbackVisible"
      class="padding-dialog"
      title="异常反馈"
      width="1000px"
      ...
      <el-table
        ...
        <el-table-column align="center" label="已选wafer数量"/>
        <el-table-column align="center" label="选择片子">
          <template slot-scope="scope">
            <el-button type="primary" icon="el-icon-upload2" size="mini" @click="selectFilm(scope.row)">选择</el-button>
          </template>
        </el-table-column>
        <el-table-column align="center" label="异常原因"/>
      </el-table>
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitAbnormal">提交异常</el-button>
        <el-button @click="abnormalFeedbackVisible = false">取消</el-button>
      </span>
    </el-dialog>
    <el-dialog
      :close-on-click-modal="false"
      ...
      width="800px"
      @close="handleClose('siteForm')">
      <span>系统检测到以下wafer有多个 COW文件，请选择文件</span>
      <el-table
        :data="list"
        style="margin-top: 10px"
        class="site-table"
        ...
        <el-table-column align="center" label="WaferID"/>
        <el-table-column align="center" label="生产类型"/>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitAbnormalWafer">确定</el-button>
        <el-button @click="selectWaferVisible = false">取消</el-button>
      </span>
    </el-dialog>
  </PageHeaderLayout>
</template>
...
<style scoped>
  ...
  .file-table>>> .el-radio:last-child{
    margin-bottom: 0;
    border-bottom: none;
  }
  .search-input-scan{
