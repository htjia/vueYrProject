  ...
  <PageHeaderLayout >
    ...
    <el-dialog
      ...
      <fieldset class="fieldest" style="margin-top: 15px;">
        ...
        <div class="edit-dialog" style="width: 1132px;margin-top: 50px;height:400px">
          <pl-table
            ...
            <pl-table-column fixed align="center" label="Bin" width="65px">
              <template slot-scope="scope">
                {{ scope.row.level }}
              </template>
            </pl-table-column>
            <pl-table-column label="VFL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VFH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VF2L" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VF2H" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VF3L" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VF3H" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VF4L" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VF4H" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VFDL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VFDH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VZL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="VZH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="IRL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="IRH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="IRESDAL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="IRESDAH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="LOPL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="LOPH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="WLDL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="WLDH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="BSL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="BSH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="DVFL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="DVFH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="HWL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="HWH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="WLPL" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="WLPH" align="center" width="65px">
              <template slot-scope="scope">
            ...
            <pl-table-column label="Type" align="center" width="65px">
              <template slot-scope="scope">
                <span v-if="scope.row.level!==clickId">{{ scope.row.typeName }}</span>
                <el-select v-if="scope.row.level===clickId" v-model="scope.row.type" class="search-input" size="small" style="width:90%" placeholder="请选择" filterable @change="getNewType(scope.row.level)">
                  <el-option
...
<style scoped>
  ...
  .edit-dialog>>>.el-table .set_error td{
