  ...
  <PageHeaderLayout >
    ...
    <div class="app-container run-table">
      ...
      >
        ...
        <el-table-column v-for="value in titleList" :key="value.cnname" :label="value.cnname" align="center" width="140px" show-overflow-tooltip>
          <template slot-scope="scope">
    ...
    <el-dialog
      ...
      <el-form ref="machineForm" :model="machineForm" :rules="rules" status-icon label-width="140px" label-position="right">
        <el-form-item label="光色 " prop="colorId">
          <el-select v-model="machineForm.colorId" class="search-input" style="width: 320px;" size="small" placeholder="请选择光色" filterable clearable>
            <el-option
        ...
        <el-form-item label="型号 " prop="modelId">
          <el-select v-model="machineForm.modelId" class="search-input" style="width: 320px;" size="small" placeholder="请选择型号" filterable clearable>
            <el-option
              v-for="item in modelList"
              :key="item.id"
              :label="item.code"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="handleClose('machineForm')">取 消</el-button>
      </span>
    </el-dialog>
    <el-dialog
      :close-on-click-modal="false"
      ...
      <el-form ref="machineForm" :model="machineForm" :rules="rules" status-icon label-width="140px" label-position="right">
        <el-form-item label="光色 " prop="colorId">
          <el-select v-model="machineForm.colorId" class="search-input" style="width: 325px;" size="small" placeholder="请选择光色" filterable clearable>
            <el-option
              v-for="item in colorList"
              :key="item.id"
              :label="item.code"
        ...
        <el-form-item label="型号 " prop="modelId">
          <el-select v-model="machineForm.modelId" class="search-input" style="width: 325px;" size="small" placeholder="请选择型号" filterable clearable>
            <el-option
              v-for="item in modelList"
              :key="item.id"
              :label="item.code"
