    ...
    <el-dialog
      ...
      <el-form ref="machineForm" :model="machineForm" :rules="rules" status-icon label-width="100px" label-position="right">
        <el-form-item label="光色 " prop="colorId">
          <el-select v-model="machineForm.colorId" class="search-input" style="width: 365px;" size="small" placeholder="请选择光色" filterable>
            <el-option
        ...
        <el-form-item label="型号 " prop="modelId">
          <el-select v-model="machineForm.modelId" class="search-input" style="width: 365px;" size="small" placeholder="请选择型号" filterable>
            <el-option
              v-for="item in modelList"
              :key="item.id"
              :label="item.code"
