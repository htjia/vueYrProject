...
import { queryList, queryLists, addDetail, updateDetail, deleteDetail } from '@/api/chipBasicInfoManage/codeManage/brightnessCode'
export default {
  ...
  methods: {
    ...
    // 删除按钮
    handleDelete(row) {
      this.$confirm('此操作将永久删除当前亮度信息, 是否继续?', '提示', {
