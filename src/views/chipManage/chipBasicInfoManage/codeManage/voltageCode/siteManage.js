...
import { queryList, queryLists, addDetail, updateDetail, deleteDetail } from '@/api/chipBasicInfoManage/codeManage/voltageCode'
export default {
  ...
  methods: {
    ...
    // 删除按钮
    handleDelete(row) {
      this.$confirm('此操作将永久删除当前电压信息, 是否继续?', '提示', {
