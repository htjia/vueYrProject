  ...
  <PageHeaderLayout >
      ...
      <div class="search-box">
        <div class="left-search-box">
          <div class="input-item">
            <span class="input-title" style="width:90px">波长STD范围 </span>
    ...
    <div class="app-container">
      <el-table
        ...
        border
        fit>
        <el-table-column align="center" label="波长STD范围" prop="scope"/>
    ...
    <el-dialog
      ...
      <el-form ref="machineForm" :model="machineForm" :rules="rules" status-icon label-width="110px" label-position="right">
        <el-form-item label="波长STD范围 " required>
          <el-row>
            <el-col :span="11">
        ...
        <el-form-item label="代码 " prop="code">
          <el-input v-model="machineForm.code" placeholder="请输入代码" maxlength="20"/>
        </el-form-item>
      </el-form>
