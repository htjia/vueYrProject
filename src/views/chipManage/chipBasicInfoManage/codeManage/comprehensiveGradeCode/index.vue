  ...
  <PageHeaderLayout >
      ...
      <div class="search-box">
        <div class="left-search-box">
          <div class="input-item">
            <span class="input-title" style="width:90px">综合等级范围 </span>
    ...
    <div class="app-container">
      <el-table
        ...
        border
        fit>
        <el-table-column align="center" label="综合等级范围" prop="scope"/>
        ...
        <el-table-column label="正/副品" align="center">
          <template slot-scope="scope">
            <span v-if="scope.row.quality === 0">
              正品
            </span>
            <span v-if="scope.row.quality === 1">
              副品
            </span>
          </template>
        </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="machineForm" :model="machineForm" :rules="rules" status-icon label-width="110px" label-position="right">
        <el-form-item label="综合等级范围 " required>
          <el-row>
            <el-col :span="11">
        ...
        <el-form-item label="分类 " prop="classify">
          <el-input v-model="machineForm.classify" placeholder="请输入分类" maxlength="20"/>
        </el-form-item>
        <el-form-item label="正/副品 " prop="quality">
          <el-select v-model="machineForm.quality" style="width:350px" placeholder="请选择" filterable clearable>
            <el-option
