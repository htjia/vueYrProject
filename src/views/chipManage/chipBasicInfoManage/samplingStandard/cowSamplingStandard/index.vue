<template>
  <PageHeaderLayout >
      ...
      <div class="search-box">
        ...
        <div class="right-btn-box">
          <el-button
            ...
            type="primary"
            @click="handleAdd"
          ><svg-icon icon-class="add"/> 新增COW采样标准</el-button>
        </div>
      </div>
    </div>
    ...
    <el-dialog
      ...
      <!-- <div>
        <el-button type="primary" style="margin: 15px 0px 0px;" size="small" @click="addConfig()">采样条件和抛除坏点后条件的字段配置</el-button>
      </div> -->
      <el-row>
        <el-col :span="12" style="padding: 15px 15px 15px 0;">
          <fieldset class="fieldest" style="width:100%">
            ...
            <el-table
              ...
              fit
              stripe>
              <el-table-column label="字段" align="center" width="200px">
                <template slot-scope="scope">
                  <el-select v-model="scope.row.field" class="search-input" size="mini" style="width:90%" placeholder="请选择" filterable @change="fieldChange1(scope.row)">
                    <el-option
              ...
              <el-table-column label="最小值" align="center">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.minVal" class="search-input" style="width:90%" placeholder="" size="small" maxlength="8" clearable/>
                </template>
              </el-table-column>
              <el-table-column label="最大值" align="center">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.maxVal" class="search-input" style="width:90%" placeholder="" size="small" maxlength="8" clearable/>
                </template>
              </el-table-column>
              <el-table-column label="操作" align="center" width="60px">
                <template slot-scope="scope">
                  <i class="deleteBtn el-icon-remove" style="margin-right: 15px;" @click="removeCY(scope.$index)"/>
                </template>
              </el-table-column>
            </el-table>
          </fieldset>
        </el-col>
        <el-col :span="12" style="padding: 15px 0 15px 15px;">
          <fieldset class="fieldest" style="width:100%">
            <legend class="legendsty"> 抛除坏点后条件 </legend>
            <el-button type="primary" style="margin: -10px 0px 5px;" size="small" @click="addPCHD()">增加</el-button>
            <el-table
              v-loading="listLoading"
              :data="pchdList"
              element-loading-text="拼命加载中"
              ...
              <el-table-column label="字段" align="center" width="200px">
                <template slot-scope="scope">
                  <el-select v-model="scope.row.field" class="search-input" size="mini" style="width:90%" placeholder="请选择" filterable @change="fieldChange2(scope.row)">
                    <el-option
                      v-for="item in newFieldList1"
                      :key="item.thKey"
                      :label="item.thName"
                      :value="item.thKey"
                      :disabled="item.disabled"/>
              ...
              <el-table-column label="操作" align="center" width="60px">
                <template slot-scope="scope">
                  <i class="deleteBtn el-icon-remove" style="margin-right: 15px;" @click="removeHD(scope.$index)"/>
                </template>
              </el-table-column>
            </el-table>
          </fieldset>
      ...
      <!-- <div>
        <el-button type="primary" style="margin: 15px 0px 0px;" size="small" @click="addConfig1()">传接片标准和变色条件的字段配置</el-button>
      </div> -->
      <el-row>
        <el-col :span="12" style="padding:15px 15px 15px 0">
          <fieldset class="fieldest" style="width:100%">
            <legend class="legendsty"> 传接片标准 </legend>
            <el-button type="primary" style="margin: -10px 0px 5px;" size="small" @click="addCHP()">增加</el-button>
            <el-table
              v-loading="listLoading"
              :data="cjbzList"
              element-loading-text="拼命加载中"
              ...
              <el-table-column label="字段" align="center" width="200px">
                <template slot-scope="scope">
                  <el-select v-model="scope.row.field" class="search-input" size="mini" style="width:90%" placeholder="请选择" filterable @change="fieldChange(scope.row)">
                    <el-option
                      v-for="item in cowBaseList1"
                      :key="item.thKey"
                      :label="item.thName"
                      :value="item.thKey"/>
                  </el-select>
              ...
              <el-table-column label="值" align="center" width="180px">
                <template slot-scope="scope">
              ...
              <el-table-column label="操作" align="center" width="60px">
                <template slot-scope="scope">
                  <i class="deleteBtn el-icon-remove" style="margin-right: 15px;" @click="removeCHP(scope.$index)"/>
                </template>
              </el-table-column>
            </el-table>
          </fieldset>
        ...
        <el-col :span="12" style="padding: 15px 0 15px 15px;">
          <fieldset class="fieldest" style="width:100%">
            <legend class="legendsty"> 变色条件 </legend>
            <el-button type="primary" style="margin: -10px 0px 5px;" size="small" @click="addBS()">增加</el-button>
            <el-table
              v-loading="listLoading"
              :data="bstjList"
              element-loading-text="拼命加载中"
              ...
              <el-table-column label="操作" align="center" width="60px">
                <template slot-scope="scope">
                  <i class="deleteBtn el-icon-remove" style="margin-right: 15px;" @click="removBS(scope.$index)"/>
                </template>
              </el-table-column>
            </el-table>
          </fieldset>
      ...
      <el-dialog
        ...
        <div>
          <el-row>
            <el-col :span="11">
              <fieldset class="fieldest" style="width:100%">
                <legend class="legendsty"> 已选中字段 {{ leftTree1[0].children.length }} </legend>
                <el-tree
                  ref="lefttree1"
                  :data="leftTree1"
                  :props="defaultProps"
            ...
            <el-col :span="11">
              <fieldset class="fieldest" style="width:100%">
                <legend class="legendsty"> 待选中字段 {{ rightTree1[0].children.length }} </legend>
                <el-tree
                  ref="righttree1"
                  :data="rightTree1"
                  :props="defaultProps"
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button @click="configDialogVisible1 = false">取 消</el-button>
        </span>
      </el-dialog>
    </el-dialog>
    <el-dialog
      ...
      <!-- <div>
        <el-button type="primary" style="margin: 15px 0px 0px;" size="small" @click="addConfigs()">采样条件和抛除坏点后条件的字段配置</el-button>
      </div> -->
      <el-row>
        <el-col :span="12" style="padding: 15px 15px 15px 0;">
          <fieldset class="fieldest" style="width:100%">
      ...
      <!-- <div>
        <el-button type="primary" style="margin: 15px 0px 0px;" size="small" @click="addConfigs1()">传接片标准和变色条件的字段配置</el-button>
      </div> -->
      <el-row>
        <el-col :span="12" style="padding:15px 15px 15px 0">
          <fieldset class="fieldest" style="width:100%">
      ...
      <el-dialog
        ...
        <div>
          <el-row>
            <el-col :span="11">
              <fieldset class="fieldest" style="width:100%">
                <legend class="legendsty"> 已选中字段 {{ leftTrees[0].children.length }} </legend>
                <el-tree
                  ref="lefttrees"
                  :data="leftTrees"
                  :props="defaultProps"
            ...
            <el-col :span="11">
              <fieldset class="fieldest" style="width:100%">
                <legend class="legendsty"> 待选中字段 {{ rightTrees[0].children.length }} </legend>
                <el-tree
                  ref="righttrees"
                  :data="rightTrees"
                  :props="defaultProps"
      ...
      <el-dialog
        :visible.sync="configDialogVisibles1"
        width="800px"
        top="80px"
        class="tip-out-inner-dialog"
        title="配置"
        ...
        <div>
          <el-row>
            <el-col :span="11">
              <fieldset class="fieldest" style="width:100%">
                <legend class="legendsty"> 已选中字段 {{ leftTrees1[0].children.length }} </legend>
                <el-tree
                  ref="lefttrees1"
                  :data="leftTrees1"
                  :props="defaultProps"
            ...
            <el-col :span="2" style="text-align: center;font-size: 36px;color: #009494">
              <div style="margin-top: 260px;cursor: pointer;" @click="toLefts1">
                <svg-icon icon-class="left"/>
              </div>
              <div style="cursor: pointer;" @click="toRights1">
                <svg-icon icon-class="right"/>
              </div>
            </el-col>
            <el-col :span="11">
              <fieldset class="fieldest" style="width:100%">
                <legend class="legendsty"> 待选中字段 {{ rightTrees1[0].children.length }} </legend>
                <el-tree
                  ref="righttrees1"
                  :data="rightTrees1"
                  :props="defaultProps"
        ...
        <span slot="footer" class="dialog-footer">
          <el-button type="primary" @click="getTitles1()">确 定</el-button>
          <el-button @click="configDialogVisibles1 = false">取 消</el-button>
        </span>
      </el-dialog>
    </el-dialog>
  </PageHeaderLayout>
