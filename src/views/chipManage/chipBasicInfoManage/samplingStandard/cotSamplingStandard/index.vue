  ...
  <PageHeaderLayout >
      ...
      <div class="search-box">
        ...
        <div class="right-btn-box">
          <el-button
            ...
            type="primary"
            @click="handleAdd"
          ><svg-icon icon-class="add"/> 新增COT采样标准</el-button>
        </div>
      </div>
    </div>
    ...
    <el-dialog
      ...
      <fieldset class="fieldest" style="width:100%">
        ...
        <!-- <div class="input-item" style="width:100%;text-align:left">
          <span class="input-title" style="width:90px">选择已有标准 </span>
          <el-select v-model="allready" :disabled="true" class="search-input" size="small" placeholder="请选择" clearable @change="setHasBZ">
            <el-option
