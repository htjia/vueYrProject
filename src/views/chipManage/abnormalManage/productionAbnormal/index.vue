  ...
  <PageHeaderLayout >
      ...
      <div class="search-box">
        <div class="left-search-box">
          ...
          <div class="input-item">
            ...
            <el-select v-model="status" class="search-input" style="width: 90px" size="small" placeholder="请选择" filterable clearable>
              <el-option
          ...
          <div class="input-item">
            ...
            <el-input v-model="waferNo" class="search-input" style="width: 190px" placeholder="请输入片号" size="small" maxlength="20" clearable/>
          </div>
          <div class="input-item">
          ...
          <div class="input-item">
            ...
            <el-select v-model="creator" class="search-input" style="width: 120px" size="small" placeholder="请选择" filterable clearable>
              <el-option
    ...
    <div class="app-container">
      <el-table
        ...
        <el-table-column label="流程卡" align="center" width="190px" show-overflow-tooltip>
          <template slot-scope="scope">
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="openCheck()">判 定</el-button>
          ...
          <el-col :span="24" style="padding-top: 15px;">
            ...
            <div v-show="radio === 1">
              ...
              <div style="text-align: center;">
                ...
                <el-button v-if="isready" type="primary" size="small" @click="determine(5)">整批返工</el-button>
              </div>
            </div>
            <div v-show="radio === 2">
    ...
    <el-dialog
      ...
      <el-form ref="mulForm" :model="mulForm" :rules="mulrules" status-icon label-width="80px" label-position="right">
        <el-form-item label="批号" prop="mulWaferID">
          <el-input v-model="mulForm.mulWaferID" :rows="10" type="textarea" placeholder="请输入多个批号,以换行分割" />
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
