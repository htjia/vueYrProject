    ...
    <el-dialog
      ...
      <el-form ref="colorModelForm" :model="colorModelForm" :rules="rules" status-icon label-width="65px" label-position="right">
        <el-form-item label="编号 " prop="code">
          <el-input v-model="colorModelForm.code" onkeyup="this.value=this.value.replace(/\s+/g,'')" placeholder="请输入编号" type="text" maxlength="1"/>
        </el-form-item>
        <el-form-item label="名称 " prop="name">
          <el-input v-model="colorModelForm.name" onkeyup="this.value=this.value.replace(/\s+/g,'')" placeholder="请输入名称" type="text" maxlength="20"/>
        </el-form-item>
        <el-form-item label="备注 ">
          <el-input v-model="colorModelForm.remark" onkeyup="this.value=this.value.replace(/\s+/g,'')" placeholder="请输入备注" type="text" maxlength="50"/>
        </el-form-item>
      </el-form>
