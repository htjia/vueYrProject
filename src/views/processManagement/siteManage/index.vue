    ...
    <el-dialog
      ...
      <el-form ref="siteForm" :model="siteForm" :rules="rules" status-icon label-width="100px" label-position="right">
        <el-form-item label="车间 " prop="plant">
          <el-select v-model="siteForm.plant" placeholder="请选择车间" style="width: 260px" filterable>
            <el-option
        ...
        <el-form-item label="站点名称 " prop="siteName">
          <el-input v-model="siteForm.siteName" onkeyup="this.value=this.value.replace(/\s+/g,'')" placeholder="请输入站点名称" maxlength="20"/>
        </el-form-item>
      </el-form>
