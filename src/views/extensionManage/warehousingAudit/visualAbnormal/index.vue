  ...
  <PageHeaderLayout >
      ...
      <div class="search-box">
        <div class="left-search-box" style="margin-bottom: -10px;">
          <div class="input-item" style="margin-bottom: 10px;">
            ...
            <el-input v-model="billNo" class="search-input" style="width:130px" placeholder="请输入单号" size="small" maxlength="20" clearable/>
          </div>
          <div class="input-item" style="margin-bottom: 10px;">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="确认人" align="center" prop="auditorName"/>
      ...
      <el-table
        ...
        <el-table-column label="目检等级" align="center" prop="oldVisualName"/>
        <el-table-column label="原因" align="center" prop="oldReasonName"/>
        <el-table-column label="修正后等级" align="center" prop="newVisualName"/>
