...
import { exceptionList } from '@/api/extensionManage/audit/warehousing'
export default {
  ...
  methods: {
    ...
    exportAll() {
      window.open(process.env.BASE_API + `/zl-visual-amend/export-data-new?exceptionId=${this.rowInfo.id}&billNo=${this.rowInfo.billNo}`)
    }
  }
}
