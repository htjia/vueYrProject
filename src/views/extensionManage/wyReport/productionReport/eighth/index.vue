  ...
  <div>
    <div class="module-container" style="margin-top: 10px;">
      ...
      <div class="module-title flex">
        <div class="module-title-text">查看光强</div>
      ...
      <div class="module-content flex coloum" style="height: auto">
        ...
        <div class="left-search-box" style="margin-left: -10px;margin-top: -15px;">
          <div style="flex:1">
            ...
            <div class="input-item">
              ...
              <el-select v-model="colorSeries" clearable multiple collapse-tags class="search-input" size="small" placeholder="请选择" filterable @change="findColorType">
                <el-option
        ...
        <div>
          <div v-if="isChart">
            <chart id="arqck" :options="option" height="300px" width="100%" @arqClick="arqClick"/>
            <chart id="ajtck" :options="option1" height="300px" width="100%" @arqClick="ajtClick"/>
            <chart id="aruncck" :options="option2" height="300px" width="100%"/>
          </div>
          <div v-else class="chart-table">
            <el-table
              ...
              border
              fit>
              <el-table-column label="机台" align="center" prop="machineCode" width="130"/>
              <el-table-column label="RunId" align="center" prop="runId"/>
              <el-table-column label="光强" align="center" prop="ii"/>
