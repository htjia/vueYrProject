  ...
  <div class="page_break">
    <div class="module-container" style="margin-top: 10px;">
      ...
      <div class="module-title flex">
        <div class="module-title-text">{{ extension === 0 ? 'S品、R品各机台产量周对比':'S品、R品各机台入库量周对比' }}</div>
      ...
      <div class="module-content flex coloum" style="height: auto">
        ...
        <div class="left-search-box" style="margin-left: -10px;margin-top: -15px;">
          <div style="flex:1">
            ...
            <div class="input-item">
              ...
              <el-select v-model="productId" clearable multiple collapse-tags style="width:200px" class="search-input" size="small" placeholder="请选择" filterable @change="changeProduct">
                <el-option
            ...
            <div class="input-item">
              ...
              <el-select v-model="colorSeries" clearable style="width:145px" multiple collapse-tags class="search-input" size="small" placeholder="请选择" filterable @change="findColorType">
                <el-option
            ...
            <div class="input-item">
              ...
              <el-select v-model="colorId" clearable style="width:130px" multiple collapse-tags class="search-input" size="small" placeholder="请选择" filterable @change="changeMeasure">
                <el-option
            ...
            <div class="input-item">
              ...
              <el-select v-model="substrateTypeId" clearable style="width:130px" multiple collapse-tags class="search-input" size="small" placeholder="请选择" filterable>
                <el-option
                  v-for="item in screenObj.typeList"
                  :key="item.id"
                  :label="item.name"
                  :value="item.id"/>
              </el-select>
            ...
            <div class="input-item">
              ...
              <el-select v-model="measureId" clearable style="width:130px" class="search-input" size="small" placeholder="请选择" filterable @change="changeMeasure">
                <el-option
            ...
            <template v-if="isChart">
              ...
              <div class="input-item">
                ...
                <el-select v-model="manyLevel" clearable style="width:130px" class="search-input" size="small" placeholder="请选择" filterable>
                  <el-option
                    v-for="item in screenObj.levelWeek"
                    :key="item.id"
                    :label="item.name"
                    :value="item.id"/>
                </el-select>
        ...
        <div>
          <div v-if="isChart" class="charts-right">
            <chart id="SRpgjtdb" :options="option" height="300px" width="100%"/>
          </div>
          <div v-else class="chart-table">
            <el-table
              ...
              border
              fit>
              <el-table-column label="机台" align="center" prop="machine" width="130"/>
