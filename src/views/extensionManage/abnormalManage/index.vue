    ...
    <div class="header-search-add height-auto">
      <div class="header-btn-group">
        ...
        <el-button
          size="small"
          type="primary"
        ><svg-icon icon-class="add"/> 导出</el-button>
        <el-button
          size="small"
          class="float-right"
          type="primary"
      ...
      <el-row>
        <el-col :span="22">
          ...
          <div class="input-item">
            ...
            <el-select v-model="siteType" class="search-input" size="small" placeholder="请选择" clearable>
              <el-option
          ...
          <div class="input-item">
            ...
            <el-select v-model="siteType" class="search-input short-input" size="small" placeholder="请选择" clearable>
              <el-option
                v-for="item in siteSelectOptions"
                :key="item.id"
                :label="item.name"
    ...
    <el-dialog
      ...
      <el-form ref="siteForm" :model="siteForm" :rules="rules" status-icon label-width="100px" label-position="right">
        <el-form-item label="站点类型 " prop="siteType">
          <el-select v-model="siteForm.siteType" placeholder="请选择站点类型" style="width: 260px">
            <el-option
        ...
        <el-form-item label="站点状态 " prop="siteStatus">
          <el-select v-model="siteForm.siteStatus" placeholder="请选择站点状态" style="width: 260px">
            <el-option
