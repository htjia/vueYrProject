  ...
  <PageHeaderLayout >
      ...
      <el-row>
        <el-col :span="21">
          <div class="input-item">
            ...
            <el-input v-model="searchKeys.platterNo" class="search-input" placeholder="Platter_No" size="small" maxlength="20" clearable/>
          </div>
          <div class="input-item">
          ...
          <div class="input-item">
            <span class="input-title" style="width: auto">初次使用时间</span>
            <el-date-picker
              v-model="beginDate"
    ...
    <div class="app-container">
      <el-table
        ...
        <el-table-column label="厂家名称" align="center" prop="manufacturer" show-overflow-tooltip/>
        <el-table-column label="厂家盘号" align="center" prop="manufacturerPlatterNo" show-overflow-tooltip width="150"/>
        <el-table-column label="备注" align="center" prop="remark" show-overflow-tooltip/>
        <el-table-column label="尺寸" align="center" prop="measureName" show-overflow-tooltip width="60"/>
        <el-table-column label="片数" align="center" prop="slice" show-overflow-tooltip width="60"/>
        <el-table-column label="所属机台" align="center" prop="machineName" show-overflow-tooltip width="90"/>
        ...
        <el-table-column label="额定寿命(次)" align="center" prop="ratedLife" width="95" show-overflow-tooltip/>
        <el-table-column label="使用次数" align="center" prop="useCount" width="80" show-overflow-tooltip/>
        ...
        <el-table-column label="使用记录" align="center" prop="status" width="80">
          <template slot-scope="scope">
            <div style="color: #009494;font-weight: bold;cursor: pointer;text-decoration:underline" @click="viewPlatterUsageLog(scope.row)">查看详情</div>
          </template>
        </el-table-column>
        <el-table-column label="操作" align="center" prop="status" width="250">
          <template slot-scope="scope">
            <el-button v-if="scope.row.status !== 1" type="primary" size="mini" icon="el-icon-edit" @click="handleEdit(scope.row)">编辑</el-button>
            <el-button v-if="scope.row.status !== 1" type="primary" size="mini" @click="handlePrint(scope.row)"><svg-icon icon-class="print"/> 打印条码</el-button>
            <el-button
    ...
    <el-dialog
      ...
      <el-form ref="mocvdForm" :model="mocvdForm" :rules="rules" status-icon label-width="110px" label-position="right">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="Platter_No" prop="platterNo">
              ...
              <el-select v-model="mocvdForm.alphabet" style="width: 81px" placeholder="请选择" filterable @change="alphabetChange">
                <el-option
              ...
              <el-input v-model="mocvdForm.platterNo" placeholder="请输入6位字符" maxlength="6" style="width: 123px;" oninput="this.value=this.value.replace(/[^0-9a-zA-Z]/g,'');" @keyup.native="platterNum"/>
            </el-form-item>
            <el-form-item label="厂家名称" prop="cjmc">
              <el-input v-model="mocvdForm.cjmc" placeholder="请输入厂家名称" maxlength="20"/>
            </el-form-item>
            <el-form-item label="额定寿命" prop="edsm">
              <el-input v-model="mocvdForm.edsm" placeholder="请输入额定寿命" type="text" maxlength="5" oninput="this.value=this.value.replace(/[^0-9]/g,'');"/>
            </el-form-item>
            <el-form-item label="使用次数" prop="sycs">
              <el-input v-model="mocvdForm.sycs" placeholder="请输入使用次数" type="text" maxlength="5" oninput="this.value=this.value.replace(/[^0-9]/g,'');"/>
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="所属机台" prop="ssjt">
              <el-select v-model="mocvdForm.ssjt" placeholder="请选择所属机台" style="width: 250px" filterable @change="machineChange">
                <el-option
                  v-for="item in machineList"
                  :key="item.id"
                  :label="item.code"
        ...
        <el-form-item label="异常片位">
          <el-select v-model="mocvdForm.abnormalPlace" multiple placeholder="请选择异常片位" style="width: 630px" filterable>
            <el-option
              v-for="item in abnormalPlace"
              :key="item"
              :label="item"
              :value="item"/>
          </el-select>
      ...
      <el-form ref="mocvdForm" :model="mocvdForm" :rules="rules" status-icon label-width="110px" label-position="right">
        <el-row :gutter="20">
          <el-col :span="12">
            ...
            <el-form-item label="使用次数" prop="sycs">
              <el-input :disabled="true" v-model="mocvdForm.sycs" type="text" maxlength="5" oninput="this.value=this.value.replace(/[^0-9]/g,'');"/>
            </el-form-item>
            <el-form-item label="大盘尺寸" prop="measureId">
              <el-select :disabled="true" v-model="mocvdForm.measureId" placeholder="请选择大盘尺寸" style="width: 250px" filterable @change="measureIdChange">
                <el-option
                  v-for="item in measureList"
                  :key="item.id"
                  :label="item.name"
          ...
          <el-col :span="12">
            <el-form-item label="所属机台" prop="ssjt">
              <el-select v-model="mocvdForm.ssjt" placeholder="请选择所属机台" style="width: 250px" filterable>
                <el-option
                  v-for="item in machineList"
                  :key="item.id"
                  :label="item.name"
          ...
          <el-row>
            <el-col :span="17">
              ...
              >
                ...
                <el-table-column label="开始" align="center" prop="name">
                  <template slot-scope="scope">
                    <el-input :disabled="true" v-model="scope.row.cricleStart" style="width: 95%" type="text" maxlength="3" oninput="this.value=this.value.replace(/[^0-9]/g,'');" size="small" @blur="circleStartInputChange(scope.row, scope.$index)"/>
                  </template>
                </el-table-column>
                <el-table-column label="结束" align="center" prop="name">
                  <template slot-scope="scope">
    ...
    >
      ...
      >
        ...
        <el-table-column label="异常片位" align="center" prop="abnormalSlice" show-overflow-tooltip/>
        <el-table-column label="异常原因" align="center" prop="abnormalReason" show-overflow-tooltip/>
