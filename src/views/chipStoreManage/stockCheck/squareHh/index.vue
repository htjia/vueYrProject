<template>
  <PageHeaderLayout >
        ...
        <el-row>
          <el-col :span="23">
            ...
            <div class="input-item">
              ...
              <el-input v-model="searchKey.waferID" class="search-input" placeholder="请输入ChipNo" size="small" maxlength="20" clearable/>
            </div>
            <div class="input-item">
    ...
    <el-dialog
      ...
      <div class="cut-line" style="margin: 5px 0"/>
      <div class="input-item">
        <span class="input-title-long">ESD测试电压(正向)</span>
      ...
      <div class="input-item">
        <span class="input-title-long">ESD测试电压(反向)</span>
