<template>
  <PageHeaderLayout >
      ...
      <div style="height: auto;">
        <el-row>
          <el-col :span="23">
            ...
            <div class="input-item">
              <span class="input-title">外延尺寸 </span>
              <el-select v-model="searchKey.wycc" class="search-input" size="small" placeholder="请选择" filterable clearable>
                <el-option
    ...
    <div class="app-container">
      ...
      <span class="container-title">圆片数据库</span>
      <span style="margin-left: 10px;font-weight: bold">(Tol: {{ totalPage }} 片，{{ sliceCount }} K)</span>
    ...
    <el-dialog
      ...
      <div class="input-item" style="margin-right: 0">
        <span class="input-title" style="width: 91px;">集中度代码</span>
        <el-select v-model="searchKey.jzddm" class="search-input" size="small" placeholder="请选择" filterable clearable>
          <el-option
      ...
      <div class="input-item">
        <span class="input-title">归一亮度</span>
        <el-input v-model="searchKey.gyld" class="search-input" placeholder="请输入归一亮度" size="small" maxlength="20" clearable/>
      </div>
      <div class="input-item" style="margin-right: 0">
        <span class="input-title" style="width: 91px;">综合等级代码</span>
        <el-select v-model="searchKey.zhpddj" class="search-input" size="small" placeholder="请选择" filterable clearable>
          <el-option
      ...
      <div>
        ...
        <!---->
        <span class="params-title">VF2</span>
        <span class="input-title-params">MIN</span>
        <el-input v-model="searchKey.VF2MINmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF2MINmax" class="search-input-params" size="small" type="number" clearable/>
        <span class="input-title-params">MAX</span>
        <el-input v-model="searchKey.VF2MAXmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF2MAXmax" class="search-input-params" size="small" type="number" clearable/>
        <span class="input-title-params">AVG</span>
        <el-input v-model="searchKey.VF2AVGmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF2AVGmax" class="search-input-params" size="small" type="number" clearable/>
        <span class="input-title-params">STD</span>
        <el-input v-model="searchKey.VF2STDmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF2STDmax" class="search-input-params" size="small" type="number" clearable/>
        <!---->
        <span class="params-title">VF3</span>
        <span class="input-title-params">MIN</span>
        <el-input v-model="searchKey.VF3MINmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF3MINmax" class="search-input-params" size="small" type="number" clearable/>
        <span class="input-title-params">MAX</span>
        <el-input v-model="searchKey.VF3MAXmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF3MAXmax" class="search-input-params" size="small" type="number" clearable/>
        <span class="input-title-params">AVG</span>
        <el-input v-model="searchKey.VF3AVGmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF3AVGmax" class="search-input-params" size="small" type="number" clearable/>
        <span class="input-title-params">STD</span>
        <el-input v-model="searchKey.VF3STDmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF3STDmax" class="search-input-params" size="small" type="number" clearable/>
        <!---->
        <span class="params-title">VF4</span>
        <span class="input-title-params">MIN</span>
        <el-input v-model="searchKey.VF4MINmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF4MINmax" class="search-input-params" size="small" type="number" clearable/>
        <span class="input-title-params">MAX</span>
        <el-input v-model="searchKey.VF4MAXmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF4MAXmax" class="search-input-params" size="small" type="number" clearable/>
        <span class="input-title-params">AVG</span>
        <el-input v-model="searchKey.VF4AVGmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF4AVGmax" class="search-input-params" size="small" type="number" clearable/>
        <span class="input-title-params">STD</span>
        <el-input v-model="searchKey.VF4STDmin" class="search-input-params" size="small" type="number" clearable/> ~
        <el-input v-model="searchKey.VF4STDmax" class="search-input-params" size="small" type="number" clearable/>
        <!---->
        ...
        <div class="cut-line" style="margin: 0"/>
        <div class="input-item">
          <span class="input-title-long">HW1均值</span>
          <el-select v-model="searchKey.HW1JZOperator" class="operator-select" size="small" filterable>
            <el-option
          ...
          <el-input v-model="searchKey.HW1JZ" class="search-input-params" size="small" type="number" clearable/>
        </div>
        <div class="input-item">
          <span class="input-title-long">综合良率</span>
          <el-select v-model="searchKey.zhlvOperator" class="operator-select" size="small" filterable>
            <el-option
              v-for="item in operatorOptions"
              :key="item.name"
              :label="item.name"
          ...
          <el-input v-model="searchKey.zhlv" class="search-input-params" size="small" type="number" clearable/>
        </div>
        <div class="input-item">
          <span class="input-title-long">VF1良率</span>
          <el-select v-model="searchKey.vf1Operator" class="operator-select" size="small" filterable>
            <el-option
              v-for="item in operatorOptions"
              :key="item.name"
              :label="item.name"
          ...
          <el-input v-model="searchKey.vf1lv" class="search-input-params" size="small" type="number" clearable/>
        </div>
        <div class="input-item" style="margin-right: 0">
          <span class="input-title-long">VF2良率</span>
          <el-select v-model="searchKey.vf2Operator" class="operator-select" size="small" filterable>
            <el-option
              v-for="item in operatorOptions"
              :key="item.name"
              :label="item.name"
          ...
          <el-input v-model="searchKey.vf2lv" class="search-input-params" size="small" type="number" clearable/>
        </div>
        <div class="input-item">
          <span class="input-title-long">VF3良率</span>
          <el-select v-model="searchKey.vf3Operator" class="operator-select" size="small" filterable>
            <el-option
              v-for="item in operatorOptions"
              :key="item.name"
              :label="item.name"
          ...
          <el-input v-model="searchKey.vf3lv" class="search-input-params" size="small" type="number" clearable/>
        </div>
        <div class="input-item">
          <span class="input-title-long">VF4良率</span>
          <el-select v-model="searchKey.vf4Operator" class="operator-select" size="small" filterable>
            <el-option
              v-for="item in operatorOptions"
              :key="item.name"
              :label="item.name"
          ...
          <el-input v-model="searchKey.vf4lv" class="search-input-params" size="small" type="number" clearable/>
        </div>
        <div class="input-item">
          <span class="input-title-long">IR良率</span>
          <el-select v-model="searchKey.IROperator" class="operator-select" size="small" filterable>
            <el-option
              v-for="item in operatorOptions"
              :key="item.name"
              :label="item.name"
          ...
          <el-input v-model="searchKey.IRlv" class="search-input-params" size="small" type="number" clearable/>
        </div>
      </div>
      <div class="input-item" style="margin-right: 0">
        <span class="input-title-long">DVF良率</span>
        <el-select v-model="searchKey.dvfOperator" class="operator-select" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.DVFlv" class="search-input-params" size="small" type="number" clearable/>
      </div>
      <div class="input-item">
        <span class="input-title-long">WLD良率</span>
        <el-select v-model="searchKey.wldOperator" class="operator-select" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.WLDlv" class="search-input-params" size="small" type="number" clearable/>
      </div>
      <div class="input-item">
        <span class="input-title-long">WLP良率</span>
        <el-select v-model="searchKey.wlpOperator" class="operator-select" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.WLPlv" class="search-input-params" size="small" type="number" clearable/>
      </div>
      <div class="input-item">
        <span class="input-title-long">WLC良率</span>
        <el-select v-model="searchKey.wlcOperator" class="operator-select" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.WLClv" class="search-input-params" size="small" type="number" clearable/>
      </div>
      <div class="input-item" style="margin-right: 0">
        <span class="input-title-long">VZ良率</span>
        <el-select v-model="searchKey.vzOperator" class="operator-select" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.VZlv" class="search-input-params" size="small" type="number" clearable/>
      </div>
      <div class="input-item">
        <span class="input-title-long">VZ良率</span>
        <el-select v-model="searchKey.vzOperator" class="operator-select" size="small" filterable>
      ...
      <div class="input-item" style="margin-right: 10px">
        <span class="input-title-long">IV良率</span>
        <el-select v-model="searchKey.ivOperator" class="operator-select" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.IVlv" class="search-input-params" size="small" type="number" clearable/>
      </div>
      <div class="input-item">
        <span class="input-title-long" style="width: 97px;">ESD IR_A良率</span>
        <el-select v-model="searchKey.esdIraOperator" class="operator-select" style="width: 65px;" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.ESDIRAlv" class="search-input-params" size="small" type="number" clearable/>
      </div>
      <div class="input-item" style="margin-right: 0">
        <span class="input-title-long" style="width: 100px;padding-right: 4px">Wld_5nm良率</span>
        <el-select v-model="searchKey.wld5nmOperator" class="operator-select" style="width: 65px;" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.Wld5nmlv" class="search-input-params" style="width: 70px;" size="small" type="number" clearable/>
      </div>
      <div class="input-item">
        <span class="input-title-long" style="width: 100px;padding-right: 4px">Wlp_5nm良率</span>
        <el-select v-model="searchKey.wlp5nmOperator" class="operator-select" style="width: 80px;" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.Wlp5nmlv" class="search-input-params" style="width: 85px;" size="small" type="number" clearable/>
      </div>
      <div class="input-item">
        <span class="input-title-long" style="width: 130px">ESD测试电压(正向)</span>
        <el-select v-model="searchKey.ESDcsdyzxOperator" class="operator-select" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.ESDcsdyzx" class="search-input-params" size="small" type="number" clearable/>
      </div>
      <div class="input-item">
        <span class="input-title-long" style="width: 130px">ESD测试电压(反向)</span>
        <el-select v-model="searchKey.ESDcsdyfxOperator" class="operator-select" size="small" filterable>
          <el-option
            v-for="item in operatorOptions"
            :key="item.name"
            :label="item.name"
        ...
        <el-input v-model="searchKey.ESDcsdyfx" class="search-input-params" size="small" type="number" clearable/>
      </div>
