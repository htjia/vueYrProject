    ...
    <div class="header-search-add height-auto">
      ...
      <div style="height: auto;">
        ...
        <div class="input-item">
          ...
          <el-input :rows="3" v-model="putInRemark" class="dialog-input" placeholder="请输入备注" type="textarea" maxlength="50" clearable/>
        ...
        <div>
          <div class="input-item">
            ...
            <el-input :disabled="true" v-model="listNum" class="search-input" style="width: 180px;" placeholder="请选择送片单" size="small" maxlength="20" clearable/>
          </div>
          <div class="input-item">
